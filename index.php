...
<body background="img/naranja3.png">
	<div class="wrapper fadeInDown">
		<div id="formContent">
			...
			<div class="fadeIn first">
				...
				<h1 ><font color="#E3A25A" face="verdana">Gestor de Archivos</h1></font>
			</div>
			...
			<!-- Remind Passowrd -->
			<div id="formFooter">
				<a class="underlineHover" href="registro.php" ><font face="verdana">REGISTRAR</a>
			</div>
