...
if (isset($_SESSION['usuario'])) {
	...
	<div class="jumbotron jumbotron-fluid">
		<div class="container">
			<h1 class="display-4" align="center"><font color="#E3A25A" ><b><font face='serif'>Gestor de Archivos</h1></b>
			<br>
			<br>
			<span class="btn btn-secondary"  data-toggle="modal" data-target="#modalAgregarArchivos">
				<span class="fas fa-plus-circle"><font color="#E3A25A" ></span> Agregar Archivos
			</span> 
			<hr>
