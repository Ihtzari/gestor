...
<div class="row">
	<div class="col-sm-12">
		<div class="table-responsive">
			<table class="table table-hover table-primary" id="tablaGestorDataTable"  background="../img/Fondo.jpg">
				<thead>
					<tr>
						<th align="center"><font color= FFFFFF>Categoria</th>
						<th align="center"><font color= FFFFFF>Nombre</th>
						<th align="center"><font color= FFFFFF>Extensión de archivo</th>
						<th align="center"><font color= FFFFFF >Descargar</th>
						<th align="center"><font color= FFFFFF >Visualizar</th>
						<th align="center"><font color= FFFFFF >Eliminar</th>
					</tr>
				</thead>
				<tbody>
					<?php 
						...
						*/
							...
							while($mostrar = mysqli_fetch_array($result)) {
								...
								?>
								<tr>
									<td align="center"><font color= FFFFFF ><?php echo $mostrar['categoria'] ?></td>
									<td align="center"><font color= FFFFFF ><?php echo $mostrar['nombreArchivo'] ?></td>
									<td align="center"><font color= FFFFFF ><?php echo $mostrar['tipoArchivo'] ?></td>
									<td align="center">
